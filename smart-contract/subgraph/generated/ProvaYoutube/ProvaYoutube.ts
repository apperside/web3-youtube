...
export class ProvaYoutube__videosResult {
  value0: BigInt;
  value1: string;
  value2: string;
  value3: string;
...
export class ProvaYoutube extends ethereum.SmartContract {
  static bind(address: Address): ProvaYoutube {
    return new ProvaYoutube("ProvaYoutube", address);
  }
  ...
  videos(param0: BigInt): ProvaYoutube__videosResult {
    ...
    return new ProvaYoutube__videosResult(
      result[0].toBigInt(),
      result[1].toString(),
      result[2].toString(),
      result[3].toString(),
  ...
  try_videos(param0: BigInt): ethereum.CallResult<ProvaYoutube__videosResult> {
    ...
    return ethereum.CallResult.fromValue(
      new ProvaYoutube__videosResult(
        value[0].toBigInt(),
        value[1].toString(),
        value[2].toString(),
        value[3].toString(),
